  ...
  **/
  ...
  var url = "http://extreme-ip-lookup.com/json/"
  var opts = {
  ...
  var message = ""
  const paras = ["query","ipName","ipType","org","isp","country","region","city"]
  const paran = ["IP","Host","Type","Org","ISP","Country","Region","City"]
  $task.fetch(myRequest).then(response => {
    message = response? json2info(response.body,paras) : ""
      $done({"title":"🔎 eXTReEe-IP-LOOKUP 查询结果","message":message});
  }, reason => {
    message = "\n\n🛑 查询超时"
      $done({"title": "🔎 eXTReEe-IP-LOOKUP 查询结果", "message": message});
  })
